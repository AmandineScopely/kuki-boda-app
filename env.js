...
const BUNDLE_ID = 'com.kukiboda'; // ios bundle id
const PACKAGE = 'com.kukiboda'; // android package name
const NAME = 'KukiBoda'; // app name
const EXPO_ACCOUNT_OWNER = 'Amandine Levecq'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'KukiBodaApp'; // app scheme
